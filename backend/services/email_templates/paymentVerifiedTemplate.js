// backend/services/email_templates/paymentVerifiedTemplate.js

const getPaymentVerifiedTemplate = (order, myOrdersUrl, logoUrl) => `
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="max-width: 600px; margin: auto; background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 8px rgba(0,0,0,0.05);">
      ...
      <tr>
        <td style="padding: 20px 40px; text-align: center;">
          <h1 style="color: #28a745; font-size: 28px; margin-bottom: 20px;">¡Pago Verificado para Pedido #${order.orderNumber}!</h1>
          <p style="font-size: 16px; margin-bottom: 10px;">
            Hola ${order.userName || order.userEmail},
          </p>
          <p style="font-size: 16px; margin-bottom: 20px;">
            Queremos confirmarte que hemos recibido y verificado exitosamente tu pago para el pedido #${order.orderNumber}.
          </p>
          <p style="font-size: 16px; margin-bottom: 30px;">
            Tu pedido ha sido marcado como <strong style="color: #28a745;">PAGADO</strong> y pronto será preparado para el envío.
          </p>
...
module.exports = getPaymentVerifiedTemplate;
